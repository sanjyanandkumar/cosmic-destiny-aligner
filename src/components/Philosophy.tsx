  ...
  const principles = [
    {
      ...
      title: "Energy",
      description:
        "The inner vibration of the creator and the venture. Energy defines what you attract.",
    },
    {
      icon: Clock,
      title: "Timing",
      description:
        "The cosmic alignment of planetary movements with business cycles. Timing defines when you act.",
    },
    {
      icon: Target,
      title: "Intention",
      description:
        "The spiritual clarity behind your goals. Intention defines why you build.",
    },
  ];
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="font-inter text-lg text-muted-foreground leading-relaxed">
                At BrahmaX, we believe the universe doesn't reward effort alone —
                it rewards alignment. Every soul, idea, and venture operates under a precise
                karmic rhythm, and our purpose is to decode that rhythm into action.
              </p>
            </div>

            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-8 mb-12">
              <h3 className="font-playfair text-2xl font-bold text-white mb-4 text-center">
                The Karmic Principle
              </h3>
              <p className="font-inter text-lg text-muted-foreground leading-relaxed text-center">
                Every business carries its own energetic DNA — shaped by the intentions of its founders,
                the timing of its birth, and the vibration of its name. When these frequencies are aligned,
                success flows naturally. When they aren't, even the strongest strategies face resistance.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {principles.map((p, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="text-center p-6 bg-white/10 border border-white/20 rounded-lg backdrop-blur"
                    >
            ...
            <div className="bg-white/10 border border-white/20 rounded-lg p-8 text-center backdrop-blur-sm">
              ...
              <p className="font-inter text-lg text-muted-foreground leading-relaxed mb-6">
                We approach every project as a living soul. Whether it's a luxury brand, a real estate empire,
                or a wellness retreat — we don't just create; we consecrate.
              </p>
